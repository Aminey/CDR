...
for k = 1:5
    for j = 1:length(z) 
        for i = 1:length(x)
            %change sigmas to structs???
            sigma_z_alt_components_upper(i,j,k) = Mx.alt(j,k)*(structure.inertias(2)*yU(i) - structure.inertias(3)*x(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2) + My.alt(j,k)*...
                              (structure.inertias(1)*x(i) - structure.inertias(3)*yU(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2);
            sigma_z_sea_components_upper(i,j,k) = Mx.sea(j,k)*(structure.inertias(2)*yU(i) - structure.inertias(3)*x(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2) + My.sea(j,k)*...
                              (structure.inertias(1)*x(i) - structure.inertias(3)*yU(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2);
            sigma_z_alt_components_lower(i,j,k) = Mx.alt(j,k)*(structure.inertias(2)*yL(i) - structure.inertias(3)*x(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2) + My.alt(j,k)*...
                              (structure.inertias(1)*x(i) - structure.inertias(3)*yL(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2);
            sigma_z_sea_components_lower(i,j,k) = Mx.sea(j,k)*(structure.inertias(2)*yL(i) - structure.inertias(3)*x(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2) + My.sea(j,k)*...
                              (structure.inertias(1)*x(i) - structure.inertias(3)*yL(i))/...
                              (structure.inertias(1)*structure.inertias(2) - structure.inertias(3)^2);              
        end
