...
for k = 1:5
    for j = 1:length(z)
        for i = 1:length(x)-1   %% for n number of points, there will be n flows, but the first is cut. So moving counterclockwise, you will have point 1, flow 1, point 2, flow 2, ...
